<header1 inline-template id="header">
    <header class="z-depth-1-half" :class="locationLog ? 'index' : ''">
        <nav class=" navbar navbar-expand-md navbar-dark transparent home" :class="locationLog ? 'transparent' : 'bg-noche'">
            ...
            <a type="button" class="btn bg-rojo cart" href="/cart">
                ...
                <!-- <span class="badge badge-light" @add-to-cart="getCart">{{count(session()->get('cart') ?? [])}}</span> -->
            </a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-info" aria-labelledby="navbarDropdownMenuLink-4">
                            ...
                            @endif
                            <a class="dropdown-item waves-effect waves-light" href="{{url('/logout')}}" onclick="event.preventDefault();
    ...
    Vue.component('header1', {
        ...
        methods: {
            getCart() {
                ...
                axios.get('/cart/get').then((response) => {
                    me.cartItems = response.data.units;
                }).catch(error => {
                    console.log(error);
                });
            },
        ...
        computed: {
            locationLog: function() {
                return this.$parent.locationLog;
            },
        },
        mounted() {

            this.$root.$on('add-to-cart', () => {
                this.getCart();
            });
            this.$root.$on('delete-from-cart', () => {
                this.getCart();
            });
